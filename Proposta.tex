...
% Falar sobre o passo da normalização e execução dos algoritmos, na sequência continuar com a seção sobre Personas. Antes de falar da rede bayesiana, abrir uma seção sobre as heurística adaptadas de Nielsen. Finalizar a proposta e o capítulo de teste
