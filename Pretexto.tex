...
\palavraschave{Robótica Social, Proxemics, Raciocínio Baseado em Casos, Interação Humano-Robô, Perfil Comportamental}
\end{resumo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
...
\keywords{Social Robotic, Proxemics, Case-Based Reasoning, Human-Robot Interaction, Behavior Profile}
\end{abstract}
