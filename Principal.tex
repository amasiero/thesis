...
\hypersetup{
pdftitle={Rede Bayesiana para Classificação do Usuário na Interação Humano-Robô},
...
\title{Rede Bayesiana para Classificação do Usuário na Interação Humano-Robô}
